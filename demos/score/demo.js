import { Duration, Note } from '../../library/scripts/Constants.js';
...
window.playScore = function() {
   ...
   window.audioGenerator.start();
   window.audioGenerator.setTempo(timeSigNumerator, timeSigDenominator, bpmBase, bpm);
   for (const chord of document.getElementsByClassName('chord')) {
      ...
      window.audioGenerator.playNotes('defaultTrack', noteList, durationList);
   }
}

window.pause = function() {
   window.audioGenerator.pause();
